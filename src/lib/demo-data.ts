...
export const demoZfs: ZfsInventory = {
  ...
  datasets: [
    ...
    { name: 'fast/subvol-200-disk-0', pool: 'fast', parent: 'fast', depth: 1, type: 'filesystem', mountpoint: '/fast/subvol-200-disk-0', used: 18 * gib, available: 46 * gib, referenced: 18 * gib, quota: 64 * gib, refQuota: null, volumeSize: null, usedBySnapshots: 0, usedByDataset: 18 * gib, usedByChildren: 0 },
    ...
    { name: 'fast/custom-volume', pool: 'fast', parent: 'fast', depth: 1, type: 'volume', mountpoint: '-', used: 8 * gib, available: 1.1 * tib, referenced: 8 * gib, quota: null, refQuota: null, volumeSize: 16 * gib, refReservation: null, logicalUsed: 7 * gib, logicalReferenced: 7 * gib, usedBySnapshots: 0, usedByDataset: 8 * gib, usedByChildren: 0, usedByRefReservation: 0 }
  ]
}
